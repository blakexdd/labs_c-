...
//            Console.WriteLine("Sum = {0}", sum);
            ...
            {
                if (Math.Pow(keyValue.Value.x - center_x, 2) + Math.Pow(keyValue.Value.y - center_y, 2) < 1)
                    score += 10;
                else if (Math.Pow(keyValue.Value.x - center_x, 2) + Math.Pow(keyValue.Value.y - center_y, 2) < 4)
                    score += 5;
                else if (Math.Pow(keyValue.Value.x - center_x, 2) + Math.Pow(keyValue.Value.y - center_y, 2) < 9)
                    score += 1;
                else
                    score += 0;
            }
